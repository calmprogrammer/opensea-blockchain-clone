        ...
        <div className={style.contentWrapper}>
          <div className={style.copyContainer}>
            ...
            <div className={style.description}>
              OpenSea is the world&apos;s first largest NFT markeplace
            </div>
          ...
          <div className={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
              ...
              <div className={style.author}>
                <div className={style.name}>JxxSxx1</div>
                <a
                  className="text-[#1868b7]"
                  href="https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/108114342104392653736314500859474189257367411327069604905681252862177572814849"
                >
                  Samedixs
                </a>
              </div>
